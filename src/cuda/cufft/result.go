...
// NO_WORKSPACE PARSE_ERROR INVALID_DEVICE INCOMPLETE_PARAMETER_LIST UNALIGNED_DATA INVALID_SIZE SETUP_FAILED EXEC_FAILED INTERNAL_ERROR INVALID_VALUE INVALID_TYPE ALLOC_FAILED INVALID_PLAN SUCCESS FFT result value
const (
