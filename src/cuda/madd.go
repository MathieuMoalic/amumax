...
// Add: dst = src1 + src2.
func Add(dst, src1, src2 *slice.Slice) {
	Madd2(dst, src1, src2, 1, 1)
}

// multiply-add: dst[i] = src1[i] * factor1 + src2[i] * factor2
func Madd2(dst, src1, src2 *slice.Slice, factor1, factor2 float32) {
	N := dst.Len()
	nComp := dst.NComp()
	log.AssertMsg(src1.Len() == N && src2.Len() == N, "Length mismatch between src1 and src2 in Madd2")
...
func Madd3(dst, src1, src2, src3 *slice.Slice, factor1, factor2, factor3 float32) {
	N := dst.Len()
	nComp := dst.NComp()
	log.AssertMsg(src1.Len() == N && src2.Len() == N && src3.Len() == N, "Length mismatch between src1, src2, and src3 in Madd3")
...
func Madd4(dst, src1, src2, src3, src4 *slice.Slice, factor1, factor2, factor3, factor4 float32) {
	N := dst.Len()
	nComp := dst.NComp()
	log.AssertMsg(src1.Len() == N && src2.Len() == N && src3.Len() == N && src4.Len() == N, "Length mismatch between src1, src2, src3, and src4 in Madd4")
...
func Madd5(dst, src1, src2, src3, src4, src5 *slice.Slice, factor1, factor2, factor3, factor4, factor5 float32) {
	N := dst.Len()
	nComp := dst.NComp()
	log.AssertMsg(src1.Len() == N && src2.Len() == N && src3.Len() == N && src4.Len() == N && src5.Len() == N, "Length mismatch between src1, src2, src3, src4, and src5 in Madd5")
...
func Madd6(dst, src1, src2, src3, src4, src5, src6 *slice.Slice, factor1, factor2, factor3, factor4, factor5, factor6 float32) {
	N := dst.Len()
	nComp := dst.NComp()
	log.AssertMsg(src1.Len() == N && src2.Len() == N && src3.Len() == N && src4.Len() == N && src5.Len() == N && src6.Len() == N, "Length mismatch between src1, src2, src3, src4, src5, and src6 in Madd6")
...
func Madd7(dst, src1, src2, src3, src4, src5, src6, src7 *slice.Slice, factor1, factor2, factor3, factor4, factor5, factor6, factor7 float32) {
	N := dst.Len()
	nComp := dst.NComp()
	log.AssertMsg(src1.Len() == N && src2.Len() == N && src3.Len() == N && src4.Len() == N && src5.Len() == N && src6.Len() == N && src7.Len() == N, "Length mismatch between src1, src2, src3, src4, src5, src6, and src7 in Madd7")
