...
// Sum of all elements.
func Sum(in *slice.Slice) float32 {
...
// Dot product.
func Dot(a, b *slice.Slice) float32 {
	nComp := a.NComp()
...
func MaxAbs(in *slice.Slice) float32 {
...
func MaxVecNorm(v *slice.Slice) float64 {
	out := reduceBuf(0)
...
func MaxVecDiff(x, y *slice.Slice) float64 {
