...
func kernMulRSymm3DAsync(fftM [3]*data.Slice, Kxx, Kyy, Kzz, Kyz, Kxz, Kxy *data.Slice, Nx, Ny, Nz int) {
	...
	kKernmulRSymm3DAsync(fftM[X].DevPtr(0), fftM[Y].DevPtr(0), fftM[Z].DevPtr(0),
...
func kernMulRSymm2DxyAsync(fftMx, fftMy, Kxx, Kyy, Kxy *data.Slice, Nx, Ny int) {
	...
	kKernmulRSymm2DxyAsync(fftMx.DevPtr(0), fftMy.DevPtr(0),
...
func kernMulRSymm2DzAsync(fftMz, Kzz *data.Slice, Nx, Ny int) {
