...
func MFMKernel(mesh MeshLike, lift, tipsize float64, cacheDir string) (kernel [3]*data.Slice) {
...
func CalcMFMKernel(kernelMesh MeshLike, lift, tipsize float64) (kernel [3]*data.Slice) {
