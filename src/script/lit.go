...
func (l floatLit) Eval() any          { return float64(l) }
func (l floatLit) Type() reflect.Type { return float64t }
func (l floatLit) Child() []Expr      { return nil }
func (l floatLit) Fix() Expr          { return l }

type intLit int

func (l intLit) Eval() any          { return int(l) }
func (l intLit) Type() reflect.Type { return intt }
func (l intLit) Child() []Expr      { return nil }
func (l intLit) Fix() Expr          { return l }

type stringLit string

func (l stringLit) Eval() any          { return string(l) }
func (l stringLit) Type() reflect.Type { return stringt }
func (l stringLit) Child() []Expr      { return nil }
func (l stringLit) Fix() Expr          { return l }

type boolLit bool

func (l boolLit) Eval() any          { return bool(l) }
func (l boolLit) Type() reflect.Type { return boolt }
