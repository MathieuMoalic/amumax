...
// func (fs *FileSystem) ReadZarr(binaryPath string, od string, logInfo func(string, ...interface{})) (*slice.Slice, error) {
...
// 	array := slice.NewSlice(zarray.Chunks[4], [3]int{zarray.Chunks[3], zarray.Chunks[2], zarray.Chunks[1]})
